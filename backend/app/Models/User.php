...
class User extends Authenticatable
{
    ...
    public function evaluationsGiven(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
    ...
    {
        return $this->hasMany(Evaluation::class, 'reviewed_id');
    }
    ...
    {
        return $this->belongsToMany(Competence::class, 'user_competence');
    }
}
