            ...
            <main>
              ...
              <div className="mb-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-secondary-500">
                    Découvrez les missions où vous pouvez aider.
                  </p>
                </div>
              ...
              {!isPostsLoading && !isPostsError && posts.length === 0 && (
                <div className="py-20 text-center text-secondary-400">
                  <p className="text-lg font-semibold">Aucune demande disponible</p>
                    ...
                    <div className="flex flex-col items-center text-center">
                      ...
                      <div className="grid grid-cols-2 w-full gap-2 border-t pt-4">
                        <div className="text-center border-r">
                          ...
                          <div className="text-[10px] uppercase text-secondary-400">
                            Aides
                          </div>
                        </div>
                      ...
                      <div key={helper.id} className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-secondary-500">
                            {helper.candidatures_count} missions réussies
                          </div>
                        </div>
                      </div>
                    ))
